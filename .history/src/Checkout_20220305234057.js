		...
		<div className="checkout">
			<div className="checkout__left">
				...
				<div className="checkout_summary">
					...
					<p>
						Current Total: <span className="indent">$50.00</span>
					</p>
					<p>
						Savings: <span className="indent">-$70.00</span>
					</p>
					<p className="red">
						Cost After Saving: <span className="indent">$0.00</span>
					</p>
					<p>
						Savings Remaining: <span className="indent">$16.00</span>
					</p>
